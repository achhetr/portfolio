	...
	<div className={featuredStyle.Container}>
		<div className={featuredStyle.LeftContainer}>
			...
			<div className={featuredStyle.ImageContainer}>
				<h4 className={featuredStyle.InfoTitle}>Covid Alert System</h4>
				<Image
			...
			<div className={featuredStyle.InfoContainer}>
				<ol className={featuredStyle.InfoList}>
					<li className={featuredStyle.InfoListItem}>
						More than{' '}
						<span className={featuredStyle.Badge}>50+ users</span>
					</li>
					<li className={featuredStyle.InfoListItem}>
					...
					<li className={featuredStyle.InfoListItem}>
						<span className={featuredStyle.Badge}>Responsives</span>{' '}
						Website
					</li>
					...
					<li className={featuredStyle.InfoListItem}>
						Using{' '}
						<span className={featuredStyle.Badge}>Python</span> for
						Automation, Web Scraping and Rest API
					</li>
					<li className={featuredStyle.InfoListItem}>
						<span className={featuredStyle.Badge}>
