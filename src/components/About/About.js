						...
						<Row>
							<Card.Text className={aboutStyle.ProfileBody}>
								<p>
									...
									experience opportunities. Skilled in React,
									React Native, Node, Git version control,
									AWS, and deploying Serverless websites using
									AWS.
								</p>
								<p>
									I am currently co-developing a Vegan Blog
									project. Check my Github{' '}
									<a
								...
								<p>
									If you weigh passion over experience for a
									junior role. I am your person who is
									passionate about creating projects and solve
									problems.
								</p>
							</Card.Text>
						</Row>
